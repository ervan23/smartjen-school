...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)({
    ...
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('api/v1/auth/signin', params).then(function (response) {
        var data = response.data;

        if (data.success) {
          _this.setAuthData(data.payload);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.register-text[data-v-0004d9e0] {\n    font-size: 0.90rem;\n}\n.sch-id[data-v-0004d9e0] {\n    text-transform: uppercase;\n}\n", ""]);
// Exports
            ...
            _c(
              ...
              [
                ...
                _c(
                  "p",
                  {
                    staticClass: "register-text text-secondary text-center mb-0"
                  },
                  [
                    _vm._v(
                      "\n\t\t\t\t\t\t\t\tDon't have account?\n\t\t\t\t\t\t\t\t"
